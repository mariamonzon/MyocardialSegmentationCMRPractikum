...
class EfficientUnet(nn.Module):
    def __init__(self, encoder, out_channels=2, concat_input=True):
        ...
        self.pointNet = PointNet(num_points=300)
        ...
        self.final_conv2 = nn.Conv2d(self.size[5], out_channels, kernel_size=1)
    ...
    def forward(self, x):
        ...
        #output_pointNet = self.pointNet(x)
